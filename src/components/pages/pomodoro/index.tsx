...
import { ChevronLast, Timer } from "lucide-react";
...
// Remember to make seconds and minutes usecontext and keep ticking/retain info even when switching between pages
